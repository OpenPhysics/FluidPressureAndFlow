/**
 * FluidPressureAndFlowButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = FluidPressureAndFlowColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link FluidPressureAndFlowColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const FLUID_PRESSURE_AND_FLOW_COMBO_BOX_OPTIONS = {
  buttonFill: FluidPressureAndFlowColors.controlSurfaceColorProperty,
  listFill: FluidPressureAndFlowColors.controlSurfaceColorProperty,
  buttonStroke: FluidPressureAndFlowColors.panelBorderColorProperty,
  listStroke: FluidPressureAndFlowColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: FluidPressureAndFlowColors.textColorProperty },
  },
